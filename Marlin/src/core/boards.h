...
#define BOARD_OPULO_LUMEN_REV4        4242  // Opulo Lumen PnP Controller REV4 (STM32F407VE / STM32F407VG)
#define BOARD_FYSETC_SPIDER_KING407   4243  // FYSETC Spider King407 (STM32F407ZG)
#define BOARD_MKS_SKIPR_V1            4244  // MKS SKIPR v1.0 all-in-one board (STM32F407VE)
#define BOARD_TRONXY_V10              4245  // TRONXY V10 (STM32F446ZE)
